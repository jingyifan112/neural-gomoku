...
| --- | --- | --- | --- | --- |
| gate_1 | 0 | True | eval_logs/integration_eval/retention_family_wrapper_threshold_gate_dryrun/gate_1.stdout.log | eval_logs/integration_eval/retention_family_wrapper_threshold_gate_dryrun/gate_1.stderr.log |

## Checkpoint action

- action: `gates_passed_no_promotion_requested`
- candidate_checkpoint: `checkpoints/probes/retention_family_wrapper_run2_weighted_candidate.pt`
