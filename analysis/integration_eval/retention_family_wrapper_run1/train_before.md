...
- output_csv: `analysis/integration_eval/retention_family_wrapper_run1/train_before.csv`
- output_md: `analysis/integration_eval/retention_family_wrapper_run1/train_before.md`
