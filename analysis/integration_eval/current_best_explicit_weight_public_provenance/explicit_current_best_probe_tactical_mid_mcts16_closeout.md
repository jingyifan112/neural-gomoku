# Explicit current-best tactical_mid public-run provenance

## Scope

- Branch: `exp/15x15-current-best-explicit-weight-public-provenance`
- This is a provenance check for archived/current-best runner reproducibility.
- It uses an explicit C weight path instead of the missing default `weights/15x15_current_best_weights.bin`.
- No training, checkpoint save, C export, promotion, or current-best overwrite was performed.

## Run configuration

- Baseline: `tactical_mid`
- Games: `24`
- Neural name: `neural_current_best_mcts16`
- MCTS sims: `16`
- Move mode: `mcts_safe`
- Explicit weights: `weights/15x15_current_best_probe_weights.bin`
...
- Final score line: `Score of neural_current_best_mcts16 vs tactical_mid: 6 - 16 - 2  [0.292] 24`
...
- Compare this explicit-weight score against archived tactical_mid `7.0/24`.
- If this reproduces `7.0/24`, the archived current-best public score is recovered with explicit weights.
- If this remains near current local `2.0/24`, the mismatch is likely in public benchmark environment/run conditions rather than the C diagnostic subset.

## Outputs

- `analysis/integration_eval/current_best_explicit_weight_public_provenance/explicit_current_best_probe_tactical_mid_mcts16_inputs.md`
- `analysis/integration_eval/current_best_explicit_weight_public_provenance/explicit_current_best_probe_tactical_mid_mcts16_run.log`
- `analysis/integration_eval/current_best_explicit_weight_public_provenance/explicit_current_best_probe_tactical_mid_mcts16_score.csv`
- `analysis/integration_eval/current_best_explicit_weight_public_provenance/explicit_current_best_probe_tactical_mid_mcts16_score.md`
- `analysis/integration_eval/current_best_explicit_weight_public_provenance/explicit_current_best_probe_tactical_mid_mcts16_summary.json`
