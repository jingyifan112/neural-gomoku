...
- output_csv: `analysis/integration_eval/retention_family_threshold_train_gate_smoke/eval_after.csv`
- output_md: `analysis/integration_eval/retention_family_threshold_train_gate_smoke/eval_after.md`
