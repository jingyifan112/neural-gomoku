...
- candidate_checkpoint: `checkpoints/probes/retention_family_gated_probe_candidate.pt`
- final_checkpoint: `checkpoints/15x15_retention_family_gated_probe_pass.pt`
...
No train/gate commands were run.
