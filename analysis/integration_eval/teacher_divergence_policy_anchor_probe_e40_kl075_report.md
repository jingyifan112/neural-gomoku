...
- out_checkpoint: `checkpoints/15x15_teacher_divergence_policy_anchor_probe_e40_kl075.pt`
- eval_csv: `analysis/integration_eval/teacher_divergence_policy_anchor_probe_e40_kl075_eval.csv`
- rows: 44
...
| after | train_candidate | 8 | 0 | 0.000 | 23.12 | 0.040258 | 4.785885 |
| after | train_teacher_divergence | 25 | 0 | 0.000 | 16.60 | 0.024789 | 5.434146 |
| after | heldout_retention | 11 | 3 | 0.273 | 21.09 | 0.189584 | 4.068496 |
| after | ALL | 44 | 3 | 0.068 | 18.91 | 0.068800 | 4.974867 |

## Before/after movement

| split | rank_improved | rank_same | rank_regressed | prob_improved | prob_same | prob_regressed |
|---|---:|---:|---:|---:|---:|---:|
| train_candidate | 8 | 0 | 0 | 6 | 0 | 2 |
| train_teacher_divergence | 8 | 12 | 5 | 7 | 0 | 18 |
