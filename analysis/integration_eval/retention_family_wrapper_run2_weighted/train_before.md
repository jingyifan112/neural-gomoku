...
- output_csv: `analysis/integration_eval/retention_family_wrapper_run2_weighted/train_before.csv`
- output_md: `analysis/integration_eval/retention_family_wrapper_run2_weighted/train_before.md`
