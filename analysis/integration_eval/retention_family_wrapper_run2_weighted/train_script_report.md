...
- out_checkpoint: `checkpoints/probes/retention_family_wrapper_run2_weighted_candidate.pt`
- eval_csv: `analysis/integration_eval/retention_family_wrapper_run2_weighted/train_script_eval.csv`
- rows: 2
