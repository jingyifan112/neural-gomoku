...
`ROUTE_AWARE_LOCAL_DECISION_BLOCKED`
...
|---|---:|---|---|
| local_decision | ROUTE_AWARE_LOCAL_DECISION_BLOCKED | INFO | Route-aware local decision only; no model eval. |
| recommended_branch | none | INFO |  |
| recommended_action | Fix blockers before continuing. | INFO |  |
| blocker_count | 3 | FAIL | route blockers present: 2; adapter blockers present: 2; post-adapter route is blocked |
| warning_count | 5 | WARN | route warnings carried forward: 1; adapter warnings carried forward: 2; combined dry-run WARN rows carried forward: 2; protected raw probability regressions carried forward: 11; tail raw probability regressions carried forward: 8 |
| final_route_decision | POST_ADAPTER_ROUTE_BLOCKED | INFO |  |
| route_decision | ROUTE_BLOCKED_FIX_ADAPTER_BLOCKERS | INFO |  |
| adapter_decision | DIRECT_PROBE_EVAL_ADAPTER_BLOCKED | INFO |  |
| route_blocker_count | 2 | FAIL |  |
| route_warning_count | 1 | WARN |  |
...
- route blockers present: 2
- adapter blockers present: 2
- post-adapter route is blocked

## Warnings

- route warnings carried forward: 1
...
- summary CSV: `analysis/integration_eval/teacher_divergence_run1_route_aware_local_decision_summary.csv`
- next plan: `analysis/integration_eval/teacher_divergence_run1_route_aware_local_decision_next_plan.txt`
- report: `analysis/integration_eval/teacher_divergence_run1_route_aware_local_decision.md`
