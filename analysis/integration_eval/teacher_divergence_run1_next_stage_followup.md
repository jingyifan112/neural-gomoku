...
|---|---:|---|---|
| followup_decision | NEXT_STAGE_FOLLOWUP_BLOCKED | INFO | No model eval in this branch. |
| followup_type | blocked_review | INFO |  |
...
| blocker_count | 2 | FAIL | dispatch blockers present: 2; dispatch decision is blocked |
| warning_count | 4 | WARN | dispatch warnings carried forward: 4; combined WARN rows carried forward: 2; protected raw probability regressions carried forward: 11; tail raw probability regressions carried forward: 8 |
...
- dispatch blockers present: 2
- dispatch decision is blocked

## Warnings

- dispatch warnings carried forward: 4
...
- summary CSV: `analysis/integration_eval/teacher_divergence_run1_next_stage_followup_summary.csv`
- decision JSON: `analysis/integration_eval/teacher_divergence_run1_next_stage_followup_decision.json`
- commands: `analysis/integration_eval/teacher_divergence_run1_next_stage_followup_commands.txt`
- report: `analysis/integration_eval/teacher_divergence_run1_next_stage_followup.md`
